...
void log_user(utente* user, log4c_category_t* log) {
    log4c_category_log(log, LOG4C_PRIORITY_DEBUG, "User id: %ld\n", user->id_utente);
    log4c_category_log(log, LOG4C_PRIORITY_DEBUG, "User name: %s\n", user->nome);
    log4c_category_log(log, LOG4C_PRIORITY_DEBUG, "User surname: %s\n", user->cognome);
    log4c_category_log(log, LOG4C_PRIORITY_DEBUG, "User email: %s\n", user->email);
    log4c_category_log(log, LOG4C_PRIORITY_DEBUG, "User lang code: %s\n", user->codice_lingua);
}